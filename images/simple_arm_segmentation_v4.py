...
if detection_result.pose_landmarks:
    ...
    for landmark_name, data in perpendicular_data.items():
        ...
        if top and bottom:
            # Both points available - draw full perpendicular line
            cv2.line(img_with_overlay, top, bottom, cyan_color, 2)
            
            # Draw magenta intersection points
            cv2.circle(img_with_overlay, top, 5, magenta_color, -1)
            cv2.circle(img_with_overlay, top, 6, (0, 0, 0), 1)
            
            cv2.circle(img_with_overlay, bottom, 5, magenta_color, -1)
            cv2.circle(img_with_overlay, bottom, 6, (0, 0, 0), 1)
            
        elif top:
            # Only top point available (shoulder case)
            # Draw line from top to center
            cv2.line(img_with_overlay, top, center, cyan_color, 2)
            
            # Draw magenta intersection point at top
            cv2.circle(img_with_overlay, top, 5, magenta_color, -1)
            cv2.circle(img_with_overlay, top, 6, (0, 0, 0), 1)
    ...
    for semi_data in upper_arm_semi_landmarks:
        if semi_data['top'] and semi_data['bottom']:
            # Draw perpendicular line
            cv2.line(img_with_overlay, semi_data['top'], semi_data['bottom'], cyan_color, 2)
            
            # Draw magenta intersection points
            cv2.circle(img_with_overlay, semi_data['top'], 5, magenta_color, -1)
            cv2.circle(img_with_overlay, semi_data['top'], 6, (0, 0, 0), 1)
            
            cv2.circle(img_with_overlay, semi_data['bottom'], 5, magenta_color, -1)
            cv2.circle(img_with_overlay, semi_data['bottom'], 6, (0, 0, 0), 1)
            
            # Draw small cyan dot at semi-landmark center
            cv2.circle(img_with_overlay, semi_data['center'], 3, cyan_color, -1)
            cv2.circle(img_with_overlay, semi_data['center'], 4, (0, 0, 0), 1)
